    ...
    <section id="about" className="py-24 bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-serif font-bold text-bakery-900 mb-4">{dictionary.infoSection.heading}</h2>
          ...
          <p className="text-bakery-700 max-w-3xl mx-auto text-lg leading-relaxed">
            {dictionary.infoSection.description}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-xl shadow-bakery-900/5 border border-bakery-100 transform hover:-translate-y-1 transition-transform duration-300">
            ...
            <h3 className="text-2xl font-serif font-bold text-bakery-800 mb-4">{dictionary.infoSection.cards.schedule.title}</h3>
            <p className="text-bakery-600 mb-4">{dictionary.infoSection.cards.schedule.description}</p>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-xl shadow-bakery-900/5 border border-bakery-100 transform hover:-translate-y-1 transition-transform duration-300">
            ...
            <h3 className="text-2xl font-serif font-bold text-bakery-800 mb-4">{dictionary.infoSection.cards.quality.title}</h3>
            <p className="text-bakery-600">
              {dictionary.infoSection.cards.quality.description}
            </p>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-xl shadow-bakery-900/5 border border-bakery-100 transform hover:-translate-y-1 transition-transform duration-300">
            ...
            <h3 className="text-2xl font-serif font-bold text-bakery-800 mb-4">{dictionary.infoSection.cards.passion.title}</h3>
            <p className="text-bakery-600">
              {dictionary.infoSection.cards.passion.description}
            </p>
