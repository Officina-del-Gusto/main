...
const products: Product[] = [
  {
    ...
    image: "https://www.jidlonacestach.cz/wp-content/uploads/2022/08/IMG_20220823_151420-scaled.jpg",
    tag: "Best Seller"
  },
  {
    id: 2,
    ...
    image: "https://simonatrusca.com/wp-content/uploads/2023/10/img_1197-1.jpg",
  },
  {
    id: 3,
    name: "Pizza de Casă",
  ...
  },
  {
    ...
    image: "https://thumbor.unica.ro/unsafe/1200x800/smart/filters:format(webp):contrast(8):quality(75)/https://retete.unica.ro/wp-content/uploads/2017/10/placinta-cu-mere1-e1507731037783.jpg",
  },
  {
    id: 5,
    name: "Covrig tip Hot Dog",
    description: "O gustare sățioasă: crenvurșt de calitate învelit în aluat pufos de covrig.",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRr7mL15x6h8aTBLC4hXOnNgAys65Eq6uiDcw&s",
    tag: "Gustare Rapidă"
  },
  {
    id: 6,
    name: "Ștrudele",
    description: "Ștrudele aurii cu diverse umpluturi dulci (brânză dulce, dovleac) sau sărate.",
    image: "https://upload.wikimedia.org/wikipedia/commons/4/40/Strudel.jpg",
  },
  {
    id: 7,
    name: "Pateuri",
    description: "Mini-delicii din foietaj cu brânză, ciuperci sau carne. Perfecte pentru orice moment al zilei.",
    image: "https://www.petitchef.ro/imgupl/recipe/foietaj-cu-ciocolata--lg-457846p714421.webp",
  },
  {
    id: 8,
    name: "Specialități de Sezon",
    description: "Întreabă în magazin de noutățile noastre! Mereu pregătim ceva special.",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrGvZUTO1xAcahiBNgm-SUMOFgLLJ7b9Us4w&s",
  }
];
    ...
    <section id="products" className="py-24 bg-bakery-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="font-cursive text-3xl text-bakery-500 block mb-2">Delicii Zilnice</span>
          <h2 className="text-4xl md:text-5xl font-serif font-bold text-bakery-900 mb-6">Produsele Noastre</h2>
          <p className="text-bakery-700 max-w-2xl mx-auto text-lg">
            Fiecare produs este preparat manual în laboratorul nostru, folosind doar ingrediente naturale.
          </p>
        </div>
